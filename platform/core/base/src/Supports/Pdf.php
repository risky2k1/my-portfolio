    ...
    public function compile(): \Barryvdh\DomPDF\PDF
    {
        ...
        if ($this->content) {
            ...
            switch ($this->supportLanguage) {
                case 'bangladesh':
                    $this->data['settings']['font_family'] = 'FreeSerif';
                    $this->data['settings']['header_html'] .= view('core/base::pdf.style-bangladesh')->render();

                    break;
                case 'chinese':
                    $this->data['settings']['font_family'] = 'msyh';
                    $this->data['settings']['header_html'] .= view('core/base::pdf.style-chinese')->render();
